...
namespace Shop18.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new AppUser { Name = Input.Name, Surname = Input.Surname, Age = Input.Age, Gender = Input.Gender, TelegramName = Input.TelegramName, FacebookURL = Input.FacebookURL, UserName = Input.Email, Email = Input.Email, /*FullName = Input.FullName*/ };
